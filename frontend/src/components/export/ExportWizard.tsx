...
// Exports must read identically for everyone — utils/formatDate.ts pins the
// format and time zone instead of following the viewer's browser locale.
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-3.5 space-y-1.5">
              ...
              <div className="pt-1.5 mt-1 border-t border-slate-200 text-[10.5px] text-slate-400 leading-relaxed">
                Generated by <span className="font-semibold text-slate-500">{config.generatedBy || '—'}</span> · {formatDateTime(new Date())}
              </div>
            </div>
          </div>
        </div>
