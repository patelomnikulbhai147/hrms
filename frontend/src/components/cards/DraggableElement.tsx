...
const HANDLE: React.CSSProperties = {
  ...
  border: '1.5px solid #C77E52', borderRadius: 2, zIndex: 5,
};
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: 'move', outline: selected ? '1.5px solid #C77E52' : '1px dashed rgba(79,124,255,0.35)',
      ...
      {selected && (
        <>
          ...
          <div onPointerDown={(e) => begin('rotate', e)}
            style={{ position: 'absolute', left: '50%', marginLeft: -6, top: -26, width: 12, height: 12, borderRadius: '50%', background: '#C77E52', border: '2px solid #fff', cursor: 'grab', zIndex: 6 }} />
          <div style={{ position: 'absolute', left: '50%', top: -14, width: 1, height: 14, background: '#C77E52' }} />
        </>
      )}
    </div>
  );
