...
export const AddressSection: React.FC<Props> = ({ values, onChange, errors, disabled }) => {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h4 className="mb-3 flex items-center gap-2 text-xs font-extrabold text-slate-700"><MapPin size={14} className="text-[#C77E52]" /> Present Address</h4>
        <Grid pfx="p_" values={values} onChange={onChange} errors={errors} disabled={disabled} requiredMark />
      </div>
      <div>
        <h4 className="mb-2 flex items-center gap-2 text-xs font-extrabold text-slate-700"><MapPin size={14} className="text-[#C77E52]" /> Permanent Address</h4>
