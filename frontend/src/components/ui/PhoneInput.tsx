...
export const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  return (
    <div className="flex flex-col gap-1 w-full text-left font-sans" ref={containerRef}>
      ...
      <div className={cn(
        "flex items-center rounded-xl border border-gray-200 bg-white shadow-sm focus-within:ring-2 focus-within:ring-brand-500 focus-within:border-brand-500 overflow-visible relative transition-all duration-200",
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected && "bg-brand-50 text-brand-800 font-semibold"
                        )}
                      >
